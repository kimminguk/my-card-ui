...
st.set_page_config(
    page_title=f"통합 챗봇 - {APP_CONFIG['page_title']}",
    page_icon="🤖",
...
def show_unified_chatbot_page(data):
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
        ...
        <h3 style="color: white; margin-bottom: 1rem; font-weight: bold;">🎯 시작하려면 아래에서 전문 분야를 선택해주세요</h3>
        <p style="color: rgba(255, 255, 255, 0.9); font-size: 1.1rem; margin-bottom: 0;">
            각 분야별로 특화된 AI 어시스턴트가 준비되어 있습니다.
        </p>
    </div>
...
def show_chat_interface(data):
    ...
    if prompt := st.chat_input(input_placeholder):
        ...
        save_chat_history(data, prompt, bot_response, chatbot_type=index_id)
